...
public class GuiConnecting extends GuiScreen
{
        ...
        (new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                try
                {
                    ...
                    EventManager.call(new ServerJoinEvent(ip));
                }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.networkManager == null)
        {
            Spicy.INSTANCE.fontManager.getFont("FONT 15").drawCenteredString(I18n.format("connect.connecting"), this.width / 2, this.height / 2 - 50, -1);
        }
        else
        {
            Spicy.INSTANCE.fontManager.getFont("FONT 15").drawCenteredString(I18n.format("connect.authorizing"), this.width / 2, this.height / 2 - 50, -1);
        }
