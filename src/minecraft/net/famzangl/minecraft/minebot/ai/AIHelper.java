...
public abstract class AIHelper {
	...
	private static float MAX_PITCH_CHANGE;
	private static float MAX_YAW_CHANGE;
	private static boolean ALLOW_TOP_OF_WORLD_HIT;
	
	static {
	    if (MinebotSettings.getSettings() != null) {
