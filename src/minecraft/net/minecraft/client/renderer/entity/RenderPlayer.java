...
import spicy.cosmetic.cosmetics.CosmeticCrown;
import spicy.cosmetic.cosmetics.CosmeticHalo;
import spicy.cosmetic.cosmetics.CosmeticHeadset;
import spicy.cosmetic.cosmetics.CosmeticWings;
...
public class RenderPlayer extends RendererLivingEntity<AbstractClientPlayer>
{
    ...
    public RenderPlayer(RenderManager renderManager, boolean useSmallArms)
    {
        ...
        this.addLayer(new CosmeticCrown(this));
        this.addLayer(new CosmeticHeadset(this));
    ...
    private void setModelVisibilities(AbstractClientPlayer clientPlayer)
    {
        ...
        else
        {
            ...
            if(ModuleManager.getModule(BetterView.class).isModuleState() || Minecraft.getMinecraft().gameSettings.thirdPersonView == 0) {
                modelplayer.bipedHead.showModel = false;
                modelplayer.bipedHeadwear.showModel = false;
            }
            }

            if(Minecraft.getMinecraft().gameSettings.thirdPersonView == 2 || !ModuleManager.getModule(BetterView.class).isModuleState()) {
                modelplayer.bipedHead.showModel = true;
                modelplayer.bipedHeadwear.showModel = true;
            }
