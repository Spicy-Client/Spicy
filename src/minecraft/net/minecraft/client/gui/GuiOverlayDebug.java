    ...
    protected void renderDebugInfoLeft()
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (!Strings.isNullOrEmpty(s))
            {
                ...
                int k = (int) Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s);
                int l = 2;
                int i1 = 2 + j * i;
                drawRect(1, i1 - 1, 2 + k + 1, i1 + j - 1, -1873784752);
                GlStateManager.color(1,1,1);
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawString(s, 2, i1, -1);
            }
        }
    }
    ...
    protected void renderDebugInfoRight(ScaledResolution scaledRes)
    {
        ...
        for (int i = 0; i < list.size(); ++i)
        {
            ...
            if (!Strings.isNullOrEmpty(s))
            {
                ...
                GlStateManager.color(1,1,1);
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawString(s, l, i1, -1);
            }
        }
    }
