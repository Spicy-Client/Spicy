...
public abstract class EntityLivingBase extends Entity
{
    ...
    public static final AttributeModifier sprintingSpeedBoostModifier = (new AttributeModifier(sprintingSpeedBoostModifierUUID, "Sprinting speed boost", (double)0.3F, 2)).setSaved(false);
