...
public class MinebotNetHandler extends NetHandlerPlayClient implements
    ...
    //    System.out.println("addToSendQueue");
	...
	public static NetworkHelper inject(AIController aiController, INetHandlerPlayClient oldHandler) {
		...
		if (netHandler != null) {
            System.out.println("handler is not null v2");
			if (!(netHandler instanceof MinebotNetHandler)) {
                System.out.println("handler is not minebot");
                ...
                System.out.println("handler is minebot");
	...
	public void handlePlayerPosLook(S08PacketPlayerPosLook packetIn) {
		LOGGER.trace(MARKER_POS, "Forced move to: " + packetIn.getX() + "," + packetIn.getY());
