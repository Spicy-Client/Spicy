...
public final class EventManager {
   ...
   public static void unregister(Object object) {
      ...
      while(var2.hasNext()) {
         ...
         while(var4.hasNext()) {
            MethodData data = (MethodData)var4.next();
   ...
   private static void register(Method method, Object object) {
      ...
      final MethodData data = new MethodData(object, method, ((SubscribeEvent)method.getAnnotation(SubscribeEvent.class)).value());
   ...
   private static void sortListValue(Class indexClass) {
      ...
      for(int var3 = 0; var3 < var4; ++var3) {
         ...
         while(var7.hasNext()) {
            MethodData data = (MethodData)var7.next();
   ...
   public static final Event call(Event event) {
      ...
      if(dataList != null) {
         if(event instanceof EventStoppable) {
            ...
            while(var4.hasNext()) {
               MethodData data1 = (MethodData)var4.next();
               invoke(data1, event);
               if(data.isStopped()) {
                  break;
               }
            ...
            while(data3.hasNext()) {
               MethodData data2 = (MethodData)data3.next();
               invoke(data2, event);
            }
         }
      }
