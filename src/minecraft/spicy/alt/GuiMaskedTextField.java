...
public class GuiMaskedTextField extends Gui
{
    ...
    public GuiMaskedTextField(final int p_i45542_1_, final FontRenderer p_i45542_2_, final int p_i45542_3_, final int p_i45542_4_, final int p_i45542_5_, final int p_i45542_6_) {
        this.text = "";
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            ...
            final String var4 = this.fontRendererInstance.trimStringToWidth(text.substring(this.lineScrollOffset), this.getWidth());
            ...
            if (var4.length() > 0) {
                ...
                var9 = this.fontRendererInstance.drawString(var10, (int)var7, (int)var8, var1);
            }
            ...
            if (var6) {
                if (var11) {
                    ...
                    this.fontRendererInstance.drawString("_", (int)var12, (int)var8, var1);
                }
            }
            if (var3 != var2) {
