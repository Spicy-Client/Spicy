    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s1.replaceAll("ı", "i").replaceAll("ğ", "g").replaceAll("Ğ", "G").replaceAll("İ", "I").replaceAll("ş", "s").replaceAll("Ş", "S"), (float)l, (float)i1, -1);
            }
            ...
            {
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s.substring(j), (float)j1, (float)i1, -1);
            }
            ...
            if (k != j)
            {
                int l1 = (int) (l + Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s.substring(0, k)));
