...
public class Gui
{
    ...
    public static void drawScaledTexturedModalRect(double x, double y, double textureX, double textureY, double width, double height, float scale) {
        ...
        wr.pos((double) (x + 0), (double) (y + height), (double) 0).endVertex();
        wr.pos((double) (x + width), (double) (y + height), (double) 0).endVertex();
        wr.pos((double) (x + width), (double) (y + 0), (double) 0).endVertex();
        wr.pos((double) (x + 0), (double) (y + 0), (double) 0).endVertex();
        tess.draw();
    }
