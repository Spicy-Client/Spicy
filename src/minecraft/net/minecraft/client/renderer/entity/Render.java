...
public abstract class Render<T extends Entity> implements IEntityRenderer
{
    ...
    protected void renderLivingLabel(T entityIn, String str, double x, double y, double z, int maxDistance)
    {
        ...
        if (d0 <= (double)(maxDistance * maxDistance))
        {
            ...
            int j = (int) (Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(str) / 2);
            GlStateManager.disableTexture2D();
            ...
            GlStateManager.depthMask(true);
            Spicy.INSTANCE.fontManager.getFont("FONT 15").drawString(str.replaceAll("ı", "i").replaceAll("ğ", "g").replaceAll("Ğ", "G").replaceAll("İ", "I").replaceAll("ş", "s").replaceAll("Ş", "S"), -Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(str) / 2, i, -1);
