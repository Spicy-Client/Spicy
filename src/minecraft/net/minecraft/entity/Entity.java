...
import spicy.module.modules.movement.Step;
...
public abstract class Entity implements ICommandSender
{
    ...
    public void moveEntity(double x, double y, double z)
    {
        ...
        else
        {
            ...
            {
                final double previousY = this.getEntityBoundingBox().minY;
                double d11 = x;
                double d7 = y;
                double d8 = z;
                ...
                try {
                    if (this instanceof EntityPlayerSP && ModuleManager.getModule(Step.class).isModuleState() && this.getEntityBoundingBox().minY - previousY > 0.5) {
                        EventManager.call(new PlayerStepEvent());
                    }
                }
                catch (Exception ex) {}
            }
