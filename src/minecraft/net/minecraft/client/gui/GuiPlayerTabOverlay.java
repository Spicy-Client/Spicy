...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, ScoreObjective scoreObjectiveIn)
    {
        ...
        {
            int k = (int) Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(this.getPlayerName(networkplayerinfo));
            i = Math.max(i, k);

            if (scoreObjectiveIn != null && scoreObjectiveIn.getRenderType() != IScoreObjectiveCriteria.EnumRenderType.HEARTS)
            {
                k = (int) Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(" " + scoreboardIn.getValueFromObjective(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
                j = Math.max(j, k);
            }
        }
        ...
        if (this.header != null)
        {
            ...
            for (String s : list1)
            {
                l1 = (int) Math.max(l1, Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s));
            }
        }
        ...
        if (this.footer != null)
        {
            ...
            for (String s2 : list2)
            {
                l1 = (int) Math.max(l1, Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s2));
            }
        }
        ...
        if (list1 != null)
        {
            ...
            for (String s3 : list1)
            {
                int i2 = (int) Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s3);
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s3, (float)(width / 2 - i2 / 2), (float)k1, -1);
        ...
        for (int k4 = 0; k4 < l3; ++k4)
        {
            ...
            if (k4 < list.size())
            {
                ...
                if (networkplayerinfo1.getGameType() == WorldSettings.GameType.SPECTATOR)
                {
                    ...
                    Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s1, (float)j2, (float)k2, -1862270977);
                }
                else
                {
                    Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s1, (float)j2, (float)k2, -1);
                }
        ...
        if (list2 != null)
        {
            ...
            for (String s4 : list2)
            {
                int j5 = (int) Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s4);
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s4, (float)(width / 2 - j5 / 2), (float)k1, -1);
                k1 += this.mc.fontRendererObj.FONT_HEIGHT;
            }
        }
    }
