...
import spicy.gui.alt.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(new GuiButton(1, width / 2 - 100, p_73969_1_, I18n.format("menu.singleplayer")));
        GlStateManager.color(1,1,1);
        this.buttonList.add(new GuiButton(2, width / 2 - 100, p_73969_1_ + p_73969_2_, I18n.format("menu.multiplayer")));

        if (Reflector.GuiModList_Constructor.exists())
        {
            this.buttonList.add(new GuiButton(14, width / 2 - 100, p_73969_1_ + p_73969_2_ * 2, I18n.format("Account Manager")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        Spicy.INSTANCE.fontManager.getFont("FONT 60").drawCenteredString("Spicy", width / 2, height / 3 - 30, new Color(i, 0, i, 220).getRGB());
        if(!Version.ok) {
            Spicy.INSTANCE.fontManager.getFont("FONT 20").drawString("You using old version!", 2, 2, -1);
            Spicy.INSTANCE.fontManager.getFont("FONT 20").drawString("Please contact developers.", 2, 10, -1);
        }
