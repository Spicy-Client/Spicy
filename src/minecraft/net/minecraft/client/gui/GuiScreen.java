...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback
{
    ...
    protected void drawHoveringText(List<String> textLines, int x, int y)
    {
        if (!textLines.isEmpty())
        {
            ...
            {
                int j = (int) Spicy.INSTANCE.fontManager.getFont("FONT 15").getWidth(s.replaceAll("ı", "i").replaceAll("ğ", "g").replaceAll("Ğ", "G").replaceAll("İ", "I").replaceAll("ş", "s").replaceAll("Ş", "S"));
            ...
            for (int k1 = 0; k1 < textLines.size(); ++k1)
            {
                ...
                Spicy.INSTANCE.fontManager.getFont("FONT 15").drawStringWithShadow(s1.replaceAll("ı", "i").replaceAll("ğ", "g").replaceAll("Ğ", "G").replaceAll("İ", "I").replaceAll("ş", "s").replaceAll("Ş", "S"), (float)l1, (float)i2, -1);
