            ...
            if (k > 0)
            {
                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                Spicy.INSTANCE.fontManager.getFont("FONT 17").drawStringWithShadow(s.replaceAll("ı", "i").replaceAll("ğ", "g").replaceAll("Ğ", "G").replaceAll("İ", "I").replaceAll("ş", "s").replaceAll("Ş", "S"), (float)i2, (float)(j2 - 9), 16777215 + (l1 << 24));
                ...
                if (flag)
                {
                    ...
                    if (l2 != i3)
                    {
                        ...
                        drawRect(0, -j3, 2, -j3 - k1, Color.blue.hashCode());
                        drawRect(2, -j3, 1, -j3 - k1, Color.blue.hashCode());
                    }
                }
