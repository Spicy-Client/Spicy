...
//                        System.gc();
    ...
    private void startGame() throws LWJGLException, IOException, InterruptedException {
        ...
        SplashProgress.setProgress(1, "ModelManager loaded.");
        Thread.sleep(500L);
        this.modelManager = new ModelManager(this.textureMapBlocks);
        this.mcResourceManager.registerReloadListener(this.modelManager);
        this.renderItem = new RenderItem(this.renderEngine, this.modelManager);
        SplashProgress.setProgress(2, "RenderItem loaded.");
        Thread.sleep(500L);
        this.renderManager = new RenderManager(this.renderEngine, this.renderItem);
        SplashProgress.setProgress(3, "RenderManager loaded.");
        Thread.sleep(500L);
        this.itemRenderer = new ItemRenderer(this);
        SplashProgress.setProgress(4, "ItemRenderer loaded.");
        Thread.sleep(500L);
        this.mcResourceManager.registerReloadListener(this.renderItem);
        this.entityRenderer = new EntityRenderer(this, this.mcResourceManager);
        SplashProgress.setProgress(5, "EntityRenderer loaded.");
        Thread.sleep(500L);
        this.mcResourceManager.registerReloadListener(this.entityRenderer);
        this.blockRenderDispatcher = new BlockRendererDispatcher(this.modelManager.getBlockModelShapes(), this.gameSettings);
        SplashProgress.setProgress(6, "BlockRenderDispatcher loaded.");
        Thread.sleep(500L);
        this.mcResourceManager.registerReloadListener(this.blockRenderDispatcher);
        this.renderGlobal = new RenderGlobal(this);
        SplashProgress.setProgress(7, "RenderGlobal loaded.");
        Thread.sleep(500L);
        this.mcResourceManager.registerReloadListener(this.renderGlobal);
        this.guiAchievement = new GuiAchievement(this);
        GlStateManager.viewport(0, 0, this.displayWidth, this.displayHeight);
        this.effectRenderer = new EffectRenderer(this.theWorld, this.renderEngine);
        SplashProgress.setProgress(8, "EffectRenderer loaded.");
        Thread.sleep(500L);
        this.checkGLError("Post startup");
        this.ingameGUI = new IngameUI(this);
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle("Spicy " + Spicy.INSTANCE.VERSION +  " (Latest)");
    ...
    private void setWindowIcon()
    {
        ...
        if (util$enumos != Util.EnumOS.OSX)
        {
            ...
            try
            {
                inputstream = Object.class.getResourceAsStream("/assets/minecraft/spicy/icon16.png");
                inputstream1 = Object.class.getResourceAsStream("/assets/minecraft/spicy/icon32.png");
    ...
    {
        DiscordAPI.getInstance().shutdown();
//    	Thread.dumpStack();
        try
        {
...
//        this.stream.func_152922_k();
            ...
            while (Keyboard.next())
            {
                ...
                if (Keyboard.getEventKeyState())
                {
                    ...
                    else
                    {
                        ...
                        for (final Module mod : Spicy.INSTANCE.moduleManager.getModules()) {
                            if (k == mod.getModuleKey()) {
                                mod.toggle();
                                Spicy.INSTANCE.moduleManager.save();
                            }
                        }
 ...
 //       System.gc();
    ...
    public static void getSmoothFPS(){
        try
        {
