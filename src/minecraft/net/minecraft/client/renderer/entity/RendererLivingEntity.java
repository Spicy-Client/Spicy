...
import spicy.module.modules.render.ESP;
import spicy.module.modules.render.NoSkin;
import spicy.utils.ESPUtils;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T>
{
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor)
    {
        ...
        float[] rgba = getRGBAs(getRainbow(6000, -15));
        NoSkin noSkin = (NoSkin) Spicy.INSTANCE.moduleManager.getModule(NoSkin.class);
        if (flag || flag1)
        {
            ...
            if (ModuleManager.getModule(ESP.class) != null && ModuleManager.getModule(ESP.class).isModuleState()) {
                if (entitylivingbaseIn instanceof EntityPlayer && Spicy.INSTANCE.settingsManager.getSettingByName("player").getValBoolean()) {
                    Color n;
                    if(FriendManager.isFriend(entitylivingbaseIn.getName())) {
                        n = new Color(5, 255, 5);
                    } else {
