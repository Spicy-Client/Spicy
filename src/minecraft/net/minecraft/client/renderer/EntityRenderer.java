...
import spicy.module.modules.player.NoHurtCam;
import spicy.module.modules.render.NoCameraClip;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        else if (ModuleManager.getModule(BetterView.class).isModuleState() ? mc.gameSettings.thirdPersonView > 1 : mc.gameSettings.thirdPersonView > 0)
        {
            ...
            else
            {
                ...
                for (int i = 0; i < 8; ++i)
                {
                    ...
                    if (movingobjectposition != null)
                    {
                        ...
                        if (d7 < d3 && !ModuleManager.getModule(NoCameraClip.class).isModuleState())
                        {
                            d3 = d7;
                        }
                    }
        ...
        {
            GlStateManager.translate(0.0F, ModuleManager.getModule(BetterView.class).isModuleState() ? -0.3F : 0.0F, 0.1F);
        }
    ...
    public void setupCameraTransform(float partialTicks, int pass)
    {
        ...
        if(!ModuleManager.getModule(NoHurtCam.class).isModuleState()) {
